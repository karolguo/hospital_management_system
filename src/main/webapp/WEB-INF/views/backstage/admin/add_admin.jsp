    ...
    <div class="page-content d-flex align-items-stretch">
        ...
        <div class="content-inner">
            <header class="page-header">
                <div class="container-fluid">
                    <h2 class="no-margin-bottom">添加管理人员</h2>
                </div>
            </header>
            <!-- LOGIN WRAPPER  -->
            ...
            <div class="table-responsive">
                ...
                <form class="form-horizontal" action="admin/addAdmin" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            <div class="form-group-material">
                                <input id="register-username" type="text" name="adminLoginName" required class="input-material">
                                <label for="register-username" class="label-material">管理员登录名称</label>
                            </div>
                            <div class="form-group-material">
                                <input id="register-username1" type="text" name="adminLoginPwd" required class="input-material">
                                <label for="register-username1" class="label-material">管理员登录密码</label>
                            </div>
                            <div class="form-group-material">
                                <input id="register-username2" type="text" name="adminRealName" required class="input-material">
                                <label for="register-username2" class="label-material">管理员真实姓名</label>
                            </div>

                            <c:choose>
                                <c:when test="${admin.role.roleId==2}">
                                    <div class="form-group-material">
                                        <input id="register-username3" type="hidden" name="role.roleId" value="2" required class="input-material">
                                        <label for="register-username3" class="label-material">挂号员</label>
                                    </div>
                                </c:when>
                                <c:otherwise>
                                        <input type="hidden" name="role.roleId" value="3"><br>
                                    <div class="form-group-material">
                                        <input id="register-username4" type="hidden" name="role.roleId" value="3" required class="input-material">
                                        <label for="register-username4" class="label-material">药剂师</label>
                                    </div>
                                </c:otherwise>
                            </c:choose>

                            <br><div class="form-group row">
                                <label class="col-sm-3 form-control-label">管理员目前状态</label>
                                <div class="col-sm-9">
                    ...
                    <%--<input type="hidden" value="addAdmin" name="flag">
                    管理员登录名称:<input type="text" name="adminLoginName"><br>
                    管理员登录密码:<input type="text" name="adminLoginPwd"><br>
                    管理员真实姓名:<input type="text" name="adminRealName"><br>
                    管理员角色名称:<c:choose>
                    <c:when test="${admin.role.roleId==2}">
                        挂号员<input type="hidden" name="role.roleId" value="2"><br>
                    </c:when>
                    <c:otherwise>
                        药剂师<input type="hidden" name="role.roleId" value="3"><br>
                    </c:otherwise>
                    </c:choose>--%>
                    <%--<select name="role.roleId">
                    <option value="2">挂号员</option>
                    <option value="3">药剂师</option>
                </select>--%>
                    <%--管理员目前状态:<select name="adminStatus">
                    <option value="1">正常运作</option>
                    <option value="0">账号停用</option>
                </select><br>--%>
