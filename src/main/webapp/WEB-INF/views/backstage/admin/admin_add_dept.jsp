    ...
    <div class="page-content d-flex align-items-stretch">
        ...
        <div class="content-inner">
            <header class="page-header">
                <div class="container-fluid">
                    <h2 class="no-margin-bottom">添加一级科室</h2>
                </div>
            </header>
            <!-- LOGIN WRAPPER  -->
            ...
            <div class="table-responsive">
                <div class="page-container">
                    <div class="mt-20">
                        <div class="card-body">
                <form class="form-horizontal" action="admin/addDept" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            <div class="form-group-material">
                                <input id="register-username" type="text" name="deptId" required class="input-material">
                                <label for="register-username" class="label-material">一级科室编号</label>
                            </div>
                            <div class="form-group-material">
                                <input id="register-username1" type="text" name="deptName" required class="input-material">
                                <label for="register-username1" class="label-material">一级科室名称</label>
                            </div>
                            <div class="form-group-material">
                                <input id="register-username2" type="text" name="describe" required class="input-material">
                                <label for="register-username2" class="label-material">一级科室介绍</label>
                            </div>
                            <div class="form-group-material">
                                <input id="register-username3" type="text" name="url" required class="input-material">
                                <label for="register-username3" class="label-material">科室路径跳转</label>
                            </div>
                            <input type="hidden" name="deptParentId" value="null"><br>
