    ...
    <div class="page-content d-flex align-items-stretch">
        ...
        <div class="content-inner">
            <header class="page-header">
                <div class="container-fluid">
                    <a href="admin/toAdminAddDoctor?deptId=${deptId}" class="no-margin-bottom">添加医生</a>
                </div>
            </header>
            <!-- LOGIN WRAPPER  -->
                    ...
                    <div class="mt-20">
                        <table class="table table-border table-bordered table-bg table-hover table-sort table-responsive">
                            ...
                            <tr>
                                ...
                                <td align="center" width="220">医生头像</td>
                                <td align="center" width="220">医生名称</td>
                                <td align="center" width="220">医生密码</td>
                                <td align="center" width="220">医生性别</td>
                                <td align="center" width="220">医生权限</td>
                                <td align="center" width="220">医生状态</td>
                                <td align="center" width="220">医生介绍</td>
                                <td align="center" width="220">医生所属科室</td>
                                <td align="center" width="220">医生职称</td>
                                <td align="center" width="220">操作</td>
                            </tr>
                            </thead>
                            <tbody>
                            <c:forEach items="${doctor1}" var="dc" varStatus="status">
                                <tr>
                                ...
                                <td align="center" width="220">${dc.doctorName}</td>
                                <td align="center" width="220">${dc.doctorPwd}</td>
                                <td align="center" width="220">${dc.doctorSex}</td>
                                <td align="center" width="220">${dc.role.roleName}</td>
                                <td align="center" width="220"><c:choose>
                                    <c:when test="${dc.doctorStatus==1}">正常运作</c:when>
                                    <c:otherwise>账号锁定</c:otherwise>
                                </c:choose></td>
                                <td align="center" width="220">${dc.doctorInfo}</td>
                                <td align="center" width="220">${dc.dept.deptName}</td>
                                <td align="center" width="220">${dc.job.jobName}</td>
                                <td align="center" width="220">
                                <c:choose >
                                    <c:when test="${dc.role.roleId==8}">无权限操作</c:when>
                                    <c:otherwise>
                                        <form  action="admin/findDoctorById" >
                                            <c:choose>
                                                <c:when test="${dc.doctorStatus==1}">
                                                    <input id="str" name="doctorId" value="${dc.doctorId}" type="hidden"/>
                                                    <input id="str" name="doctorStatus" value="0" type="hidden"/>
                                                    <input id="str" name="dept.deptId" value="${dc.dept.deptId}" type="hidden"/>
                                                    <div class="form-group row">
                                                ...
                                                <c:otherwise>
                                                    <input id="str" name="doctorId" value="${dc.doctorId}" type="hidden"/>
                                                    <input id="str" name="doctorStatus" value="1" type="hidden"/>
                                                    <input id="str" name="dept.deptId" value="${dc.dept.deptId}" type="hidden"/>
                                                    <div class="form-group row">
                                                        <div class="col-sm-4 offset-sm-3">
                                        ...
                                        <form action="admin/toFindDoctorById">
                                            <input id="str1" name="doctorId" value="${dc.doctorId}" type="hidden"/>
                                           <%-- <input id="str11" name="dept.deptId" value="${dc.dept.deptId}" type="hidden"/>--%>
                                            <div class="form-group row">
                                                <div class="col-sm-4 offset-sm-3">
