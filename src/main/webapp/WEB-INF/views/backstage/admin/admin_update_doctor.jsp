    ...
    <div class="page-content d-flex align-items-stretch">
        ...
        <div class="content-inner">
            <header class="page-header">
                <div class="container-fluid">
                    <h2 class="no-margin-bottom">修改医生人员</h2>
                </div>
            </header>
            <!-- LOGIN WRAPPER  -->
            ...
            <div class="page-container">
                <div class="mt-20">
                    <div class="card-body">
                    <form class="form-horizontal" action="admin/adminUpdateDoctorAll" method="post">
                        <input type="hidden" value="adminUpdateDoctorAll" name="flag">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <div class="form-group-material">
                                    <br><input type="text" id="register-username" name="doctorName" value="${doctor1.doctorName}" required class="input-material">
                                    <label for="register-username" class="label-material">医生名称</label>
                                </div>
                                <div class="form-group-material">
                                    <br><input type="text" id="register-username1" name="doctorPwd" value="${doctor1.doctorPwd}" required class="input-material">
                                    <label for="register-username1" class="label-material">医生密码</label>
                                </div>
                                <div class="form-group-material">
                                    <br><input type="text" id="register-username2" name="doctorInfo" value="${doctor1.doctorInfo}" required class="input-material">
