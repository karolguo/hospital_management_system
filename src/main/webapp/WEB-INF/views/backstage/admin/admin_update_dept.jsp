    ...
    <div class="page-content d-flex align-items-stretch">
        ...
        <div class="content-inner">
            <header class="page-header">
                <div class="container-fluid">
                    <h2 class="no-margin-bottom">修改科室</h2>
                </div>
            </header>
            <!-- LOGIN WRAPPER  -->
            ...
            <%--<div class="table-responsive">--%>
                <form action="admin/updateDept" method="post" class="form-horizontal">
                    <div class="line"> </div>
                    <div class="row">
                        <label class="col-sm-3 form-control-label"></label>
                        <div class="col-sm-9">
                            <br><br><div class="form-group-material">
                                <br><input id="register-username" type="text" name="deptName" value="${dept1.deptName}" required class="input-material">
                                <label for="register-username" class="label-material">科室名称</label>
                            </div>
                            <div class="form-group-material">
                                <br> <br><input id="register-username1" type="text" name="describe" value="${dept1.describe}" required class="input-material">
                                <label for="register-username1" class="label-material">科室介绍</label>
                            </div>
                    <input type="hidden" name="deptId" value="${dept1.deptId}"><br>
                    <input type="hidden" name="deptParentId" value="${dept1.deptParentId}"><br>
