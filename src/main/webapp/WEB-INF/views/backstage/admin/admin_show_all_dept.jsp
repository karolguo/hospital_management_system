    ...
    <div class="page-content d-flex align-items-stretch">
        ...
        <div class="content-inner">
            <header class="page-header">
                <div class="container-fluid" >
                    <h2 class="no-margin-bottom">查看科室信息</h2>
                </div>
            </header>
            <!-- LOGIN WRAPPER  -->
        ...
        <%--    <div class="table-responsive">
            ...
            <div class="table-responsive">
                ...
                <table class="table table-border table-bordered table-bg table-hover table-sort table-responsive">
                   ...
                   <thead>
                    <tr>
                        <td align="center" width="275">id</td>
                        <td align="center" width="275">科室名</td>
                        <td align="center" width="275">操作</td>
                        <td align="center" width="275">备注</td>
                    </tr>
                   </thead>
                    <tbody>
                    <c:forEach items="${deptList}" var="dl" >
                        <tr>
                        <td align="center" width="275">${dl.deptId}</td>
                        <td align="center" width="275">${dl.deptName}</td>
                        <td align="center" width="275">
                            <a href="admin/findSecondDeptByFirst?deptId=${dl.deptId}">管理二级科室</a>
                            <a href="admin/findDeptById?deptId=${dl.deptId}">修改</a>
                        </td>
                        <td align="center" width="275">
                        <div style="overflow:hidden;text-overflow:ellipsis;white-space:nowrap;" title="${dl.describe}">
                             简介......
                         </div>
                        </td>
                   ...
                   <%-- <p>每页${dept.pageSize}条 当前页${dept.size}条${dept.pageNum}/${dept.pages}页
                    记录数${dept.total}

                    </p>
                    <c:if test="${dept.isFirstPage==true}"><a>首页</a></c:if>
                    <c:if test="${dept.isFirstPage==false}">
                        <a href="admin/showAllDept?dept=${dept.prePage}">首页</a>
                    </c:if>
                    <c:if test="${dept.hasPreviousPage==true}">
                        <a href="admin/showAllDept?dept=${dept.prePage}">上一页</a>
                    </c:if>
                    <c:if test="${dept.hasPreviousPage==false}"><a>上一页</a></c:if>
                    <c:if test="${dept.hasNextPage==true}">
                        <a href="admin/showAllDept?dept=${dept.prePage}">下一页</a>
                    </c:if>
                   <c:if test="${dept.hasNextPage==false}">
                       <a>下一页</a>
                   </c:if>
                    <c:if test="${dept.isLastPage==true}"><a>末页</a></c:if>
                    <c:if test="${dept.isLastPage==false}">
                        <a href="admin/showAllDept?dept=${dept.lastPage}">末页</a>
                    </c:if>--%>
                        </div><%--</div>
                        </div></div>--%>
                </div>
