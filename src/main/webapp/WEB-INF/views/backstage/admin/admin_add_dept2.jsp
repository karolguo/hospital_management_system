    ...
    <div class="page-content d-flex align-items-stretch">
        ...
        <div class="content-inner">
            <header class="page-header">
                <div class="container-fluid">
                    <a href="admin/toAddDeptTwo?deptId=${deptId}" class="no-margin-bottom">添加二级科室</a>
                </div>
            </header>
            <!-- LOGIN WRAPPER  -->
            ...
            <div class="table-responsive">
                ...
                <form action="admin/" method="post">
                    <table class="table table-border table-bordered table-bg table-hover table-sort table-responsive">
                        ...
                        <tbody>
                        <c:forEach items="${deptList1}" var="dl" varStatus="status">
                        <tr>
                            <td align="center" width="275">${status.index+1}</td>
                            <td align="center" width="275">${dl.deptName}</td>
                            <td align="center" width="275">
                                <a href="admin/findDeptById?deptId=${dl.deptId}">修改</a>
                            </td>
                            <td align="center" width="275">
                                <div style="width:120px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;" title="${dl.describe}">
                                    简介......
                                </div>
                            </td>
                            </c:forEach>
