        ...
        <%--侧拉框结束--%>
            ...
            <div class="content-inner">
                <div class="card-header d-flex align-items-center">
                    ...
                    <%--<div class="card">
                        <div class="card-body">
                            <form action="findMedicalByName" class="form-inline" style="float: right;margin-right: 100px">
                                <div class="form-group">
                                    <input id="inlineFormInputGroup" name="drugName" type="text" placeholder="请输入要查询的药品名称" class="mr-3 form-control">
                                </div>
                                <div class="form-group">
