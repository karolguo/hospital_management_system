...
<div class="col-lg-4" style="margin-left: 150px;margin-top: 20px">
    <div class="card">
        <div class="card-header d-flex align-items-center" style="height: 50px">
            <h3 class="h4">${depList.deptName}</h3>
        </div>
        <div class="card-body text-center">
           <a href="card/findFirstDoctorByDeptId?deptParentId=${depList.deptParentId}&Id=${depList.deptId}"> <button type="button" data-toggle="modal" data-target="#myModal" class="btn btn-primary">点击进入 </button></a>
        </div>
    </div>
</div>
