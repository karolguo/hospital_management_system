                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12">
                                <div class="blog-content">
                                    ...
                                    <%--病例开始--%>
<c:forEach items="${allNewTitle}" var="allNewTitle">
                                            ...
                                            <div class="single-blog-left">
                                                <ul class="blog-comments-box">
                                                    <li>
                                                        <h3>
                                                        <c:choose>
                                                        <c:when test="${fn:substring(allNewTitle.newsDate,5,7)==1}">
                                                            Jan
                                                        </c:when>
                                                        <c:when test="${fn:substring(allNewTitle.newsDate,5,7)==2}">
                                                            Feb
                                                        </c:when>
                                                        <c:when test="${fn:substring(allNewTitle.newsDate,5,7)==3}">
                                                            Mar
                                                        </c:when>
                                                        <c:when test="${fn:substring(allNewTitle.newsDate,5,7)==4}">
                                                            Apr
                                                        </c:when>
                                                        <c:when test="${fn:substring(allNewTitle.newsDate,5,7)==5}">
                                                            May
                                                        </c:when>
                                                        <c:when test="${fn:substring(allNewTitle.newsDate,5,7)==6}">
                                                            June
                                                        </c:when>
                                                        <c:when test="${fn:substring(allNewTitle.newsDate,5,7)==7}">
                                                            July
                                                        </c:when>
                                                        <c:when test="${fn:substring(allNewTitle.newsDate,5,7)==8}">
                                                            Aug
                                                        </c:when>
                                                        <c:when test="${fn:substring(allNewTitle.newsDate,5,7)==9}">
                                                            Sept
                                                        </c:when>
                                                        <c:when test="${fn:substring(allNewTitle.newsDate,5,7)==10}">
                                                            Oct
                                                        </c:when>
                                                        <c:when test="${fn:substring(allNewTitle.newsDate,5,7)==11}">
                                                            Nov
                                                        </c:when>
                                                        <c:when test="${fn:substring(allNewTitle.newsDate,5,7)==12}">
                                                            Dec
                                                        </c:when>
                                                        </c:choose></h3>
                                                         <h2>${fn:substring(allNewTitle.newsDate,5,7)}</h2>${fn:substring(allNewTitle.newsDate,'',4)}</li>
                                                </ul>
                                            </div>
                                            <div class="single-blog-right">
                                                <div class="blog-content">
                                                    <h2>${allNewTitle.newsTitle}</h2>
                                                    <!-- Read more btn -->
                                                    <a class="wpcf7-submit button--itzel" href="findNewsById?newsId=${allNewTitle.newsId}">
